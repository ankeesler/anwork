 ...
 * {@link Command} is issued on the command line, {@link #run(ArgumentValues, ArgumentValues)} is
 * called on an object of this type.
 *
 * <p>
 * Created Sep 9, 2017
 * </p>
...
public interface Action {
   ...
   * <li>The second parameter contains the {@link Command} {@link Argument}'s passed to the
   * {@link Command} for which this {@link Action} is being run. The keys to this
   * {@link ArgumentValues} data is the name of the {@link Argument} (see
   * {@link Argument#getName()}).</li>
   * </ul>
   *
   ...
   * @param arguments The {@link ArgumentValues} that represent the {@link Command}'s
   *     {@link Argument}'s passed to this command
   */
